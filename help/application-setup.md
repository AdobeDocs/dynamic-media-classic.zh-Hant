...
* **[!UICONTROL 預設上傳選項]**  — 開啟「上載工作選項」對話方塊，您可以在其中指定預設上載選項。 如需有關這些選項的詳細資訊，請參閱[上載選項](/help/uploading-files.md#upload_options)。
...
* **[!UICONTROL 垃圾桶清理警告]**  — 垃圾桶中的資產會在七天內自動移除。 如果您要在永久刪除「垃圾桶」之資產的前四天傳送通知至公司管理員，請選取「在自動刪除垃圾桶項目前傳送電子郵件」。另請參閱 [管理垃圾桶資料夾](/help/trash-folder.md).
