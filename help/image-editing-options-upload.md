...
若要自動裁切影像中的空白像素，請在「上傳工作選項」對話方塊上按一下「裁切選項」****。 在&#x200B;**[!UICONTROL Crop]**&#x200B;下拉清單中，選擇&#x200B;**[!UICONTROL Trim]**。 接著選擇下列選項:

* **根據** 修剪掉 — 從此下拉式清單中，選擇根據顏色或透明度裁切：

   * **顏色**  — 選擇「顏 **** 色」選項。然後，從&#x200B;**[!UICONTROL Corner]**&#x200B;下拉清單中，選擇影像的角，該角的顏色最能代表要裁剪的空白顏色。
...
要根據影像的剪切路徑資訊建立影像的蒙版，請按一下「從剪切路徑建立蒙版」]**。**[!UICONTROL &#x200B;此選項適用於使用影像編輯應用程式所建立而具有剪裁路徑的影像。
...
另請參閱[在Scene7 Publishing System和影像伺服器上銳利化影像](/help/assets/s7_sharpening_images.pdf)。
