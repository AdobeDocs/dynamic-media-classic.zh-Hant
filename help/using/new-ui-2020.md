...
Adobe Dynamic Media Classic使用者現在可以使用新的登入，不必再仰賴瀏覽器的Adobe Flash技術。

## 常見問題集

+++**_當瀏覽器於2020年12月31日停止支援Adobe Flash時，會對Adobe Dynamic Media Classic （先前稱為Scene7）造成任何影響嗎？_**
Adobe Flash Player是網頁瀏覽器外掛程式，可讓網頁瀏覽器使用在Adobe Flash平台上開發的內容。 Adobe Dynamic Media Classic的Web使用者介面（產品中目前標示為[!DNL Scene7 Publishing System]或[!DNL SPS]）需要Adobe Flash Player。 2020年12月31日淘汰Adobe Flash後，Adobe Dynamic Media Classic客戶將無法再登入Web使用者介面。 由於這項變更，Adobe已提供客戶案頭應用程式，以取代瀏覽器體驗。
+++
...
+++**_如果我使用Adobe Dynamic Media Classic API來存取產品，而且沒有透過網頁使用者介面登入，該怎麼辦？_**
...
Adobe致力確保產品符合客戶的安全需求。 新的Adobe Dynamic Media Classic案頭應用程式持續為客戶提供符合所有Adobe安全性標準的高度安全體驗。
+++
...
+++**_新的Adobe Dynamic Media Classic案頭應用程式是否需要新的SKU？ 是否有授權成本？_**
