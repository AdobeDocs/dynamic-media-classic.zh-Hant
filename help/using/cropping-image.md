...
1. 若要裁切影像，請選取影像的滑鼠指向效果&#x200B;**[!UICONTROL 編輯]**&#x200B;按鈕，然後選取&#x200B;**[!UICONTROL 裁切]**，或在[瀏覽]面板的[詳細資料檢視]中顯示該影像，然後選取&#x200B;**[!UICONTROL 裁切]**&#x200B;按鈕。
...
1. 若要裁切影像，請選取其滑鼠指向效果&#x200B;**[!UICONTROL 編輯]**&#x200B;按鈕，然後選擇&#x200B;**[!UICONTROL 裁切]**，或在[瀏覽]面板的[詳細資料檢視]中顯示該影像，然後選取&#x200B;**[!UICONTROL 裁切]**。

1. 在「裁切編輯器」視窗中，將您要保留的影像部分放置在裁切方塊內。 選取&#x200B;**[!UICONTROL 儲存]**&#x200B;並裁切影像後，方塊內顯示的內容仍會保留。
1. 若要調整裁切區域，請執行下列其中一個動作:

   * 拖曳方塊某一側或邊角。 若要變更裁切方塊的大小但維持其外觀比例（形狀），請在拖曳時按住Shift鍵。
   * 在「大小」方框中輸入像素度量。
   * 拖曳以移動裁切方塊。 在方塊邊界內移動指標。 當您看到移動指標時，請將方塊拖曳到影像上的新位置。
