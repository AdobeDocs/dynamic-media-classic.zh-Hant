...
|--- |--- |--- |--- |--- |--- |--- |--- |--- |
| Universal_HTML5_Video（包含隱藏式字幕支援。） 請參閱[最佳實務：使用通用HTML5視訊檢視器]。(best-practice-using-html5-video.md#best_practice_using_the_html5_video_viewer) | HTML5 | X | X | X | X | X | X | X |
