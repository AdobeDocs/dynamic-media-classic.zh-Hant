...
+++**[!DNL Dynamic Media]是否使用現有的AdobeCDN （內容傳遞網路）？**
...
+++**誰符合升級計畫的資格？**
目前擁有[!DNL Dynamic Media Classic] (先前為Scene7)且也擁有[!DNL Experience Manager]的客戶。

+++

+++**如何開始升級程式？**
請連絡您的Adobe客戶團隊代表，或透過主旨列`[!DNL Dynamic Media] Upgrade Program`以[電子郵件s7support@adobe.com](mailto:s7support@adobe.com)傳送。
...
+++**是否需要升級？**
不適用。 Adobe目前及未來都完全支援並維護[!DNL Dynamic Media Classic] （客戶要求的錯誤修正、安全性修正、平台擴充性及可靠性）。
...
升級至[!DNL Dynamic Media]後，您應該只使用Dynamic Media進行影像和視訊。 您只能針對[!DNL Dynamic Media]中尚未提供的功能，繼續使用[!DNL Dynamic Media Classic]，包括下列功能：
...
+++**哪些資源可用來訓練新使用者？**
訓練可透過ADLS (Adobe數位學習服務)提供。 [!DNL Dynamic Media]功能包含在2個課程中：管理和傳遞數位Assets以及自訂數位Assets。
...
Adobe目前及未來都完全支援並維護[!DNL Dynamic Media Classic] （客戶要求的錯誤修正、安全性修正、平台擴充性及可靠性）。
...
+++**位置
我可以進一步瞭解[!DNL Dynamic Media]及其功能嗎？**
