...
UGC （使用者產生的內容）包含將資產上傳到專用的[!DNL Adobe Dynamic Media Classic]存放庫並執行相關作業。

UGC支援點陣影像檔案格式BMP、GIF、JPG、PNG、PSD、TIFF。

>[!IMPORTANT]
>
>自2023年5月1日起，Dynamic Media中的UGC資產仍可在上傳日期起的60天內使用。 60天後，資產會移除。
...
上傳資產前，您必須先取得共用機密金鑰。 使用此密鑰來擷取上載標記。 上載資產及執行其他 UGC 工作時，請送出上載標記。
