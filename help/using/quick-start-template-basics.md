...
首先請為範本上載 PSD 檔案或影像檔案。除了PSD，Adobe Dynamic Media Classic也支援許多影像檔案格式，但建議使用不失真TIFF和PNG影像作為範本，因為它們允許透明度。
...
在全域導覽列上，選取&#x200B;**[!UICONTROL 上傳]**，從您的電腦上傳PSD檔案或其他影像檔案至Adobe Dynamic Media Classic上的資料夾。 請參閱[上傳範本檔案](uploading-template-files.md#uploading_template_files)。

## 2.建立範本

若要從PSD檔案建立範本，請在上傳檔案時選取&#x200B;**[!UICONTROL 建立範本]**。 若要從影像建立範本，請在全域導覽列上，前往&#x200B;**[!UICONTROL 建置]** > **[!UICONTROL 範本基本知識]**，輸入畫布的寬度和高度測量。 在頁面的右上角附近，選取&#x200B;**[!UICONTROL Designer]**&#x200B;或&#x200B;**[!UICONTROL Developer]**，然後將影像拖曳至[範本]頁面。 您也可以在&#x200B;*之前選取影像，並移至*&#x200B;建置&#x200B;**[!UICONTROL >]**&#x200B;基本範本&#x200B;**[!UICONTROL 。]**「範本」頁面提供下列工具：
...
若要發佈範本，請將其標籤為發佈，並在全域導覽列上選取&#x200B;**[!UICONTROL 發佈]**。 然後選取&#x200B;**[!UICONTROL 送出發佈]**。 請參閱[發佈範本](publishing-templates.md#publishing_templates)。
