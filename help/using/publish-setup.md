...
>[!NOTE]
>
>如果您想在Adobe Dynamic Media Classic中設定本地化支援選項，例如「地區設定地圖」欄位，[請使用Admin Console建立支援案例。](https://helpx.adobe.com/enterprise/using/support-for-experience-cloud.html) 在您的支援案例中，要求設定說明。
