...
Adobe Dynamic Media Classic畫麵包含五個主要區域：全域導覽列、資產庫、資產篩選器標籤、瀏覽面板/建置面板和Media Cart （僅限Media Portal）。

![導覽基本知識](/help/using/assets/gs_navigation_basics_popup_popup.png)
*主要Adobe Dynamic Media Classic區域*
*A)全域導覽列； B)資產庫； C)資產篩選標籤； D)瀏覽面板； E) Media Cart （僅限Media Portal）*
...
* **[!UICONTROL 發佈]**：開啟「發佈」畫面，以便將多媒體資產發佈至Adobe Dynamic Media影像伺服器及Adobe Dynamic Media Classic SaaS基礎建設的其餘部分。

* **[!UICONTROL 工作]**：開啟[工作]畫面，讓您檢查上載和發佈工作的記錄。

* **[!UICONTROL 最近]**：開啟「最近活動」畫面，以便檢視最近修改的資產名稱，以及最近的上傳與發佈工作。

* **[!UICONTROL 設定]**：開啟設定畫面，您可以選擇設定或管理選項，以最佳化您的[!DNL Adobe Dynamic Media Classic]使用。 請參閱[設定](/help/using/setup-basics.md)。

* **[!UICONTROL 說明]**&#x200B;選擇說明選項

  * **[!UICONTROL 此主題的說明]**：開啟[說明]系統至包含您目前執行之工作相關資訊的頁面。
  * **[!UICONTROL 影片教學課程]**：存取說明如何開始每個多媒體發佈工作流程的特定主題影片。
  * **[!UICONTROL 說明內容]**：開啟[簡介]頁面的說明系統。 若要尋找和檢視不同的主題，您可以瀏覽目錄。
  * **[!UICONTROL 關於]**：顯示您正在執行的Adobe Dynamic Media Classic版本。
  * **[!UICONTROL 支援]**：提供如何取得Adobe Dynamic Media Classic技術支援的相關資訊。
...
「資產庫」面板頂端有用來尋找資產的命令。 若要尋找資產，您可以搜尋並篩選資產。 若要檢查您已刪除的資產，請選取資產庫底部的&#x200B;**[!UICONTROL 垃圾桶]**&#x200B;圖示。

>[!NOTE]
>
>您可以選取&#x200B;**[!UICONTROL 資產庫]**&#x200B;控制項以開啟或關閉資產庫，並展開可用的工作區。 選取&#x200B;**[!UICONTROL 展開]**/**[!UICONTROL 摺疊]**&#x200B;控制項以展開或摺疊面板。 這些控制項位於面板的左側。

## 瀏覽面板/建置面板 {#browse-panel-build-panel}

「瀏覽/建置」面板是您執行許多工作的位置。 此面板中可用的功能取決於您處於「瀏覽」模式還是「建置」模式。
