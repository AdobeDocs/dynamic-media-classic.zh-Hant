...
若要取消發佈工作，請前往「工作」頁面並選取 **[!UICONTROL 取消]**. 在「工作」頁面的「已排程」標籤上，您可以取消選取或選取工作的「作用中」欄內之核取方框，以暫停或繼續工作。
...
在使用者介面中，發佈的資產會在資產名稱左側以中心帶有白色勾選記號的綠色圓形圖示指出 (發佈的狀態)。取消發佈資產後，圖示會透過斜線變成灰色（未發佈狀態），
