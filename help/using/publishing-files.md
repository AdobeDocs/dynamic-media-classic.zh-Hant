...
* **[!UICONTROL 發佈]**：依預設，Adobe Dynamic Media Classic僅發佈新資產，而且以前未曾發佈過的資產（新的上次發佈後時間選項）。 不過，您可以選取 **[!UICONTROL 完整發佈]** 因此，您也可以發佈自上次發佈後已更新或變更的資產。 選取 **[!UICONTROL 包含搜尋資料的完整]** 如果您要發佈eCatalog，而且希望讀者能依關鍵字進行搜尋。
