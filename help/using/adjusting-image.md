...
1. 使用「調整編輯器」視窗右側的命令，即可調整影像:
   ...
   * 使用「色彩化」選項，即可對影像進行色彩化，同時保留陰影與亮部。對於「色彩化」選項的變更也會一直累積。從「亮度」功能表中，選擇 **[!UICONTROL 無補償]** 因此您可以停用自動亮度補償。 將對比值設為 0，即可保留原始影像的對比範圍，或是以大於 0 的值來指定對比範圍。值 100 會使對比最大化。一般值介於30到70之間。
