...
1. 在工具列右側的「資產瀏覽」面板上方，執行下列任一操作:
   ...
   * 選取&#x200B;**[!UICONTROL 格線檢視]**。 在「資產瀏覽」面板中，按兩下單一資產以在「詳細檢視」中開啟。 在右側的&#x200B;**[!UICONTROL URL和內嵌程式碼]**&#x200B;面板中，選取您想要的檢視器右側的&#x200B;**[!UICONTROL 複製URL]**。
...
部署影像集的標準方式是在網頁上放置連結（使用導覽圖示）。 選取時，連結會啟動動態頁面(JSP)，在彈出式縮放視窗中顯示「影像集」。 縮放連結會開啟包含實際縮放功能的快顯視窗。
...
使用內嵌程式碼功能可讓您檢閱所選影像集的檢視器程式碼。 您也可以將程式碼複製到剪貼簿，以便貼到網頁中來部署檢視器。 不可在「內嵌程式碼」對話框中編輯程式碼。
...
1. 在&#x200B;**[!UICONTROL 內嵌程式碼]**&#x200B;對話方塊中，選取&#x200B;**[!UICONTROL 複製到剪貼簿]**。

   不允許在&#x200B;**[!UICONTROL 內嵌程式碼]**&#x200B;對話方塊中編輯程式碼。
