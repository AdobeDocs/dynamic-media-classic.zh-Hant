...
description: 了解如何將eCatalog連結至網頁。
...
您的網站和應用程式可透過URL字串或內嵌程式碼存取Dynamic Media影像伺服器內容，包括eCatalog。 這些 URL 字串會在發佈程序中啟用。若要將eCatalog的URL字串或內嵌程式碼放入網頁和應用程式，請從Dynamic Media Classic複製。
...
1. 在「資產瀏覽」面板中，從「顯示」下拉式清單中按一下「**[!UICONTROL 目錄]**」。
