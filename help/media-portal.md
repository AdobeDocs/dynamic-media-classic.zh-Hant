...
Adobe Medium入口網站讓公司能夠輕鬆取得、控制並將已核准的資產發佈給外部合作夥伴和管道，以及內部使用者。 以瀏覽器為基礎的「自助式」環境，為入口網站使用者提供管理員控制的「檢視」，讓他們可輕鬆存取Adobe Dynamic Media Classic資產，以公司核准的格式上傳、瀏覽、搜尋、預覽和匯出資產。

有關Media Portal的詳細資訊，包括系統要求，請參閱 [使用Adobe Dynamic Media Classic Media Portal](https://help.adobe.com/en_US/scene7/mediaportal/) <!-- (https://help.adobe.com/en_US/scene7/mediaportal/index.html) -->.
