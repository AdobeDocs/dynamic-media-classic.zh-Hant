...
description: 了解如何管理eCatalog中的「資訊面板」內容。
...
1. 按兩下「eCatalog」，以在「詳細檢視」中加以開啟。
1. 按一下「資訊面板設定」面板。
1. 按一下「**[!UICONTROL 上傳S7Info內容]**」。
1. 按一下&#x200B;**[!UICONTROL 瀏覽]**，選擇要使用的以制表符分隔的TXT檔案、CSV或SSV檔案，然後按一下&#x200B;**[!UICONTROL 開啟]**。
1. 按一下&#x200B;**[!UICONTROL 上載]**。
...
1. 按一下「目錄」的滾動&#x200B;**[!UICONTROL Edit]**&#x200B;按鈕。
