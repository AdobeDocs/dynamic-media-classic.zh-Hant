...
1. （選擇性）在「影像預設集清單」的「複製URL產生的URL編碼」下拉式清單中，選取您要在複製影像資產的URL時套用的URL編碼。
1. 在「影像預設集清單」視窗中，在預覽窗格的右上方區域，針對選取的預設集類型按一下「複製URL&lt;a1/」。****
...
1. 按一下畫面右側面板上的&#x200B;**[!UICONTROL URL]**&#x200B;以展開影像預設集清單。
1. 按一下影像預設集名稱旁的「複製URL」連結，並附上您要複製至剪貼簿的URL。****
