...
**目標** ：對於上載作業，是指檔案上載到的公司名稱和資料夾。 該類別不適用於發佈工作。
...
**排序** ：選擇列名，以按特定列對清單排序。 您可以選取欄名稱旁的切換按鈕以按照遞減或遞增順序排序。

**日期範圍** ：選擇「日期範圍」功能表，然後選擇一個選項，將工作清單縮小至目前日期、上一週或上個月。 選擇「自訂日期範圍」以輸入特定日期範圍。

**作業類型** ：選擇「作業類型」菜單，然後選擇「發佈」或「上載」以縮小清單範圍以發佈作業或上載作業。 選擇「全部」可查看這兩種類型的工作。

**顯示** ：選擇「顯示」>「我的工作」或「顯示」>「所有工作」，將清單縮小為您訂購的工作或公司內人員訂購的工作。
...
**編輯循環作業** ：選擇「編輯」按鈕，並在「編輯計畫作業」對話框中輸入計畫資訊。 如果希望工作以所選時間間隔重複，可以選擇「重複」>「自訂」。
