...
要銳化影像，請按一下其變換&#x200B;**[!UICONTROL 編輯]**&#x200B;按鈕，然後選擇&#x200B;**[!UICONTROL 銳化]**，或在「詳細視圖」的「瀏覽面板」中開啟它，然後按一下&#x200B;**[!UICONTROL 銳化]**。 「銳利度編輯器」頁面隨即開啟，其中包含銳利化命令。 選擇命令，然後按一下&#x200B;**[!UICONTROL Save]**。
...
在「AdobeDynamic Media Classic」中，選擇任何影像，轉到「詳細視圖」（按兩下或按&#x200B;**[!UICONTROL 詳細視圖]**&#x200B;按鈕），然後按一下&#x200B;**[!UICONTROL 銳利化]**。 更改任何參數，然後按一下&#x200B;**[!UICONTROL Save]**。 此程式會告訴影像伺服器使用這些銳利化參數，而非您在URL中呼叫的任何命令，例如銳利化修飾元或影像預設集。 請務必發佈，以確認變更生效。
