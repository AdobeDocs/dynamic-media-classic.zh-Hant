...
For example, suppose the progressive video server name is `https://s7d9.scene7.com/is/content/`. 使用步驟 2 的語法，直接 URL 可能如下所示:
...
請參 [閱www.adobe.com/go/learn_s7_image_server_guide_en](https://www.adobe.com/go/learn_s7_image_server_guide_en)。
